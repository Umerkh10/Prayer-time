...
const PrivacyContent = () => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-4">We use the information we collect to provide, maintain, and improve our services, such as to process and complete your prayer requests, and communicate with you.</p>

      <h2 className="text-2xl font-semibold mb-4">3. Information Sharing and Disclosure</h2>
      <p className="mb-4">We may share the information we collect with third parties for various purposes, including to: comply with laws; respond to lawful requests and legal process; protect the rights and property of Global Salah, our agents, customers, and others.</p>
      ...
      <p className="mb-4">You may update, correct or delete information about you at any time by logging into your online account or by contacting us. You may also opt out of receiving promotional communications from us by following the instructions in those messages.</p>
