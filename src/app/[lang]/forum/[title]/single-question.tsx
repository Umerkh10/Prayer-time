          ...
          <Card className="overflow-hidden border-primary/20 shadow-md">
            ...
            <CardFooter className="flex justify-between py-3 border-t bg-muted/20">
              ...
              <div className="flex gap-2">
                <AnswerModal questionId={question.id} onAnswerAdded={fetchQuestionByTitle} />
      ...
      <div className="mb-6">
        ...
        {question.answers.length > 0 ? (
          <div className="space-y-6">
            {question.answers.slice().reverse().map((answer: any, index: any) => (
              <motion.div
                key={answer.id}
          ...
          <div className="text-center py-8 bg-muted/20 rounded-lg border border-primary/10">
            ...
            <p className="text-muted-foreground mb-2">No answers yet. Be the first to answer!</p>
            <AnswerModal
