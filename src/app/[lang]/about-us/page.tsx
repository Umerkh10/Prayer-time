      ...
      <section className="py-20 bg-transparent">
        <div className="container mx-auto px-4">
          ...
          {isArabic === "ar" ? ( <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-blue-50 dark:bg-blue-950 rounded-lg shadow-md p-6 text-right"
            >
              <FaHeart className="text-4xl text-blue-600 mb-4 inline-block md:mx-0 mx-auto" />
          ...
          {isArabic === "ar" ?(  <motion.div
              ...
              className="bg-blue-50 dark:bg-blue-950 rounded-lg shadow-md p-6 text-right"
            >
              <FaBrain className="text-4xl text-blue-600 mb-4 inline-block md:mx-0 mx-auto" />
              <h3 className="text-xl font-semibold mb-2 md:text-right text-center">
        ...
        {isArabic === "ar" ?(<motion.div
              ...
              className="bg-blue-50 dark:bg-blue-950 rounded-lg shadow-md p-6 text-right"
            >
              <FaBalanceScale className="text-4xl text-blue-600 mb-4 inline-block md:mx-0 mx-auto" />
              <h3 className="text-xl font-semibold mb-2 md:text-right text-center">
            ...
            {isArabic === "ar" ?(<motion.div
              ...
              className="bg-blue-50 dark:bg-blue-950 rounded-lg shadow-md p-6 text-right"
            >
              <FaClock className="text-4xl text-blue-600 mb-4 inline-block md:mx-0 mx-auto" />
              <h3 className="text-xl font-semibold mb-2 md:text-right text-center">
            ...
            {isArabic === "ar" ?(<motion.div
              ...
              className="bg-blue-50 dark:bg-blue-950 rounded-lg shadow-md p-6 text-right"
            >
              <FaUsers className="text-4xl text-blue-600 mb-4 inline-block md:mx-0 mx-auto" />
              <h3 className="text-xl font-semibold mb-2 md:text-right text-center">
