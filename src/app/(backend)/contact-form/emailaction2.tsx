                                    ...
                                    <tr>
                                      <td valign="middle" width="60">
                                        <div style="width: 50px; height: 50px; background-color: rgba(26,127,100,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
                                          <img src="https://img.icons8.com/fluency-systems-regular/48/1a7f64/ticket.png" alt="Ticket" style="width: 24px; height: 24px;">
                                        </div>
                                      </td>
                                    ...
                                    <tr>
                                      <td valign="middle" width="40">
                                        <div style="width: 30px; height: 30px; background-color: rgba(230,126,34,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
                                          <img src="https://img.icons8.com/fluency-systems-regular/48/e67e22/high-priority.png" alt="Urgent" style="width: 16px; height: 16px;">
                                        </div>
                                      </td>
                                      <td valign="middle" style="padding-left: 15px;">
                                  ...
                                  <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td valign="middle" width="30">
                                        <img src="https://img.icons8.com/fluency-systems-regular/48/ffffff/clock--v1.png" alt="Clock" style="width: 24px; height: 24px;">
                                      </td>
                                      <td valign="middle" style="padding-left: 15px;">
                              ...
                              <tr>
                                <td align="center" valign="top" style="padding-bottom: 15px;">
                                  <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td valign="middle" width="30">
                                        <img width="20" height="20" src="https://img.icons8.com/ios/50/1a7f64/new-post--v1.png" alt="new-post--v1" style="vertical-align: middle;"/>
                                      </td>
                                      <td valign="middle" >
                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td valign="middle" width="30">
                                        <img src="https://img.icons8.com/fluency-systems-regular/48/1a7f64/globe.png" alt="Website" style="width: 20px; height: 20px; vertical-align: middle;">
                                      </td>
                                ...
                                <td align="center" valign="top" style="padding: 0 8px;">
                                  <a href="#" style="display: inline-block; text-decoration: none;">
                                    <div style="width: 36px; height: 36px; background-color: #1a7f64; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                      <img src="https://img.icons8.com/fluency-systems-regular/48/ffffff/facebook-new.png" alt="Facebook" style="width: 18px; height: 18px;">
                                    </div>
                                  </a>
                                </td>
