...
function Banner({ isLoading, setIsLoading }: any) {
    ...
    return (
        <>
            {isLoading ? <div className='h-screen flex justify-center items-center md:text-5xl text-xl font-semibold z-[99999999] gap-2'><Loader2 className='md:w-11 md:h-11 w-6 h-6 animate-spin'/> Switching Language to {selectedLanguage}  </div> : <div className="relative lg:h-screen h-[700px]  bg-blue-900 bg-[url('/main-page-frame.svg')] bg-center bg-cover bg-no-repeat text-white">
