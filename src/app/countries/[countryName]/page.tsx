...
export default function CountryPage({ params }: { params: { countryName: string } }) {
  ...
  return (
    <div className=" bg-background">
      ...
      <main className="container mx-auto px-4 py-8 -mt-32 relative z-10">
        <div className="bg-background rounded-lg shadow-lg p-6 mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-blue-700 dark:text-zinc-100 py-5">Discover the {country.name}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10 max-w-6xl mx-auto">
        ...
        <div className="bg-transparent border border-muted rounded-lg shadow-md p-6">
          <h3 className="text-2xl font-semibold text-blue-700 dark:text-zinc-100">Culture & Charm</h3>
        ...
        {/* Second Column */}
        <div className="bg-transparent border border-muted rounded-lg shadow-md p-6">
          <h3 className="text-2xl font-semibold text-blue-700 dark:text-zinc-100">Nature & Biodiversity</h3>
          <p className="mt-4 text-muted-foreground">
        ...
        {/* Third Column */}
        <div className="bg-transparent border border-muted rounded-lg shadow-md p-6">
          <h3 className="text-2xl font-semibold text-blue-700 dark:text-zinc-100">Economic Powerhouse</h3>
          <p className="mt-4 text-muted-foreground">
        ...
        {/* Fourth Column */}
        <div className="bg-transparent border border-muted rounded-lg shadow-md p-6">
          <h3 className="text-2xl font-semibold text-blue-700 dark:text-zinc-100">A Laid-Back Lifestyle</h3>
          <p className="mt-4 text-muted-foreground">
