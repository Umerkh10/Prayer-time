      ...
      <CardHeader>
        ...
        <div className="flex justify-center mt-4">
          <button
            ...
            className={`px-4 py-2 mx-2 rounded ${school === "hanafi" ? "bg-blue-600 text-white" : "bg-gray-200"}`}
          >
            Hanafi
          </button>
          <button
            onClick={() => setSchool("shafi")}
            className={`px-4 py-2 mx-2 rounded ${school === "shafi" ? "bg-blue-600 text-white" : "bg-gray-200"}`}
          >
            Shafi
          </button>
        </div>
